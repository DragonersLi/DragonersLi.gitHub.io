  ...
  ([
    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc = 'https://gitee.com/DragonersLi/resource/blob/master/thumb-imgs/' + data.link[i];
            var src = 'https://gitee.com/DragonersLi/resource/blob/master/images/' + data.link[i];
      ...
      var replacer = function replacer(str) {
        var arr = str.split("/");
        return "/assets/resource/images/" + arr[arr.length - 1];
      };
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          xhr.open('GET', '/assets/resource/ins.json?t=' + +new Date(), true);
